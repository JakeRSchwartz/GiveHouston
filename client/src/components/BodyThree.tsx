...
function BodyThree () {
  return (
    <div className='body-three'>
      <div className='body-three-left'>
        <UserDiv>
          <SmallHeader>
            More than 100,000 Houstonians depend on Give Houston each year
          </SmallHeader>
          <h3 style={{ padding: '0 5rem 0 5rem' }}>
            "Being able to reach out to Give Houston with just a computer is
            nothing, but effortless. I am able to log into this website and get
            the help I need immediately." - Jodi, Event Coordinator
          </h3>
        </UserDiv>
      </div>
